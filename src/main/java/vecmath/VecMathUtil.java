...
/**
 * Utility gltf_builder.vecmath class used when computing the hash code for gltf_builder.vecmath
...
class VecMathUtil {
     ...
     * equals() method in each gltf_builder.vecmath class does a pair-wise "=="
