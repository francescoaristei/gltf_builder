...
import buffer.Normals;
import buffer.Tangents;
import buffer.TexCoords;
import buffer.TriangleIndices;
import buffer.VertexColors;
import buffer.Vertices;
...
b    * Enable or disable normals.
    ...
    /**
     * This method should be called when all shapes have added. It will serialize the gltf.MeshVertex
    ...
    /**
     * Generate primitive lists from the gltf.MeshVertex list and serialize to buffers.
     * 
     * @param _geoWriter
